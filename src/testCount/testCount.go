...
import (
	// Uncommnent for executing with sync and comment counter.Start
	"testCountChannel/counter"
	// Uncommnent for executing with sync and uncomment counter.Start
	//counter "testCountChannel/counter"
	"time"
	"fmt"
)
